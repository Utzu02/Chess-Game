...
2. **Compile the Project**
   ...
   - Build the project (usually Ctrl+F9 or Build → Build Project)
...
4. **Start Playing**
   ...
   - Click "New Game" to start your first game

## 🎮 How to Play

### Starting a New Game

1. From the main menu, click the **"New Game"** button
2. In the dialog:
   - Enter your player name (this is your in-game name, not your account email)
   - Select your color: **White** (plays first) or **Black**
3. Click **"Start Game"**
4. The game board will appear with pieces in starting positions
...
1. **Select a Piece**
   - Click on any of your pieces
   - Valid destination squares will be highlighted in **green**
   - The selected piece will be highlighted in **yellow**

2. **Move the Piece**
   - Click on a highlighted green square to move there
   - The piece will move immediately
   - Computer will make its move automatically

3. **Deselect**
   - Click on an empty square or the same piece to deselect

#### Move Validation

- You can only move your own pieces
- Invalid moves are silently prevented (no error message)
- Illegal moves (that would leave your king in check) are automatically blocked
- You cannot make a move when it's the computer's turn
...
**How to Execute**:
1. Click your king
2. Click two squares toward the rook (left or right)
3. Both pieces will move automatically

#### En Passant

**Conditions**:
- Opponent's pawn just moved two squares forward from starting position
- Your pawn is beside it
- Must be captured on the very next turn

**How to Execute**:
- The en passant capture square will be shown as a valid move
- Click on it to execute the capture

#### Pawn Promotion

**When it Happens**:
- When your pawn reaches the opposite end of the board

**How it Works**:
1. Move your pawn to the last rank
2. A dialog will appear with 4 piece options:
   - **Queen** (♕/♛) - Most powerful
   - **Rook** (♖/♜) - Second strongest
   - **Bishop** (♗/♝) - Diagonal movement
   - **Knight** (♘/♞) - L-shaped movement
3. Click your choice
4. The pawn will be replaced with the selected piece
